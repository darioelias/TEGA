...
public class LocusSpecifications {


    public static Specification<Locus> findByCriteria(final LocusCriterio criterio){

		return new SpecificationCountAbstract<Locus>(){
            ...
            protected Predicate getPredicate(
				...
				CriteriaQuery<Locus> consulta = (CriteriaQuery<Locus>) query;
