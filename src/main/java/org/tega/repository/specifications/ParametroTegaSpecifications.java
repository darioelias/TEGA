...
public class ParametroTegaSpecifications {


    public static Specification<ParametroTega> findByCriteria(final ParametroTegaCriterio criterio){

		return new SpecificationCountAbstract<ParametroTega>(){
			
            protected Predicate getPredicate(
                Root<ParametroTega> root,
