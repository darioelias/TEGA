...
public class ProcedimientoSpecifications {
    ...
    public static Specification<Procedimiento> findByCriteria(final ProcedimientoCriterio criterio){

		return new SpecificationCountAbstract<Procedimiento>(){
			
            protected Predicate getPredicate(
                Root<Procedimiento> root,
