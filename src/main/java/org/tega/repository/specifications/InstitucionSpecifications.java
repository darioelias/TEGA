...
public class InstitucionSpecifications {


    public static Specification<Institucion> findByCriteria(final InstitucionCriterio criterio){

		return new SpecificationCountAbstract<Institucion>(){
			
            protected Predicate getPredicate(
                Root<Institucion> root,
