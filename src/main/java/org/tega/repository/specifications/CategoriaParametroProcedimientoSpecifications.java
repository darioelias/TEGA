...
public class CategoriaParametroProcedimientoSpecifications {


    public static Specification<CategoriaParametroProcedimiento> findByCriteria(final CategoriaParametroProcedimientoCriterio criterio){

		return new SpecificationCountAbstract<CategoriaParametroProcedimiento>(){
			
            protected Predicate getPredicate(
                Root<CategoriaParametroProcedimiento> root,
