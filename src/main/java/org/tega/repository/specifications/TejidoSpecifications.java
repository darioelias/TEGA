...
public class TejidoSpecifications {


    public static Specification<Tejido> findByCriteria(final TejidoCriterio criterio){

		return new SpecificationCountAbstract<Tejido>(){
