...
public class EspecieSpecifications {


    public static Specification<Especie> findByCriteria(final EspecieCriterio criterio){

		return new SpecificationCountAbstract<Especie>(){
