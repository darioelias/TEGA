(function() {
    ...
    angular
        .module('proyectoApp')
        .directive('profesionalfiltros', function () {
		    return {
				restrict: 'E',
				transclude: true,
		        scope: {
				...
				templateUrl: 'app/entities/profesional/profesional-filtros.html',
				controller: ['$scope','$translate', '$translatePartialLoader',
					...
					if($scope.criterio == null || Object.keys($scope.criterio).length == 0)
						$scope.criterio = {codigo: null, idInstitucion: null, nombre: null, id: null};			
				}]
		    };
		});
